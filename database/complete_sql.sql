...
INSERT INTO user_passwords (user_id, password)
SELECT id, '$2a$12$bEB2pVDKbQaEVB/3WAR3X.3l/.JPBf3rVncxQb0eh5p3VNC5TqtJG' -- password: P0pok@tepel01
FROM users WHERE email = 'jasbootstudios@gmail.com' AND role = 'admin'
ON CONFLICT DO NOTHING;
